...
def test_UserPasswordUpdate():
    ...
    print ''
    print '----------------------------------------------------------------------'
    print 'test_UserPasswordUpdate():开始'
    sleep(1)
    ch = CTPChannel()
    data = CThostFtdcUserPasswordUpdateField()
    errorID,errorMsg,responeDataList =  ch.UserPasswordUpdate(data)
    if errorID == 0 :
        print u'共收到%d数据记录' % len(responeDataList)
        for i,responeData in enumerate(responeDataList):
            print '---------------------------------%d------------------------------------' % (i + 1)
    ...
    print 'test_UserPasswordUpdate():请求完成'

    assert errorID == 0,u'请求失败'

    print 'test_UserPasswordUpdate():执行结束'
    print '----------------------------------------------------------------------'
...
def test_SettlementInfoConfirm():
    ...
    print ''
    print '----------------------------------------------------------------------'
    print 'test_SettlementInfoConfirm():开始'
    sleep(1)
    ch = CTPChannel()
    data = CThostFtdcSettlementInfoConfirmField()
    errorID,errorMsg,responeDataList =  ch.SettlementInfoConfirm(data)
    if errorID == 0 :
        print u'共收到%d数据记录' % len(responeDataList)
        for i,responeData in enumerate(responeDataList):
            print '---------------------------------%d------------------------------------' % (i + 1)
    ...
    print 'test_SettlementInfoConfirm():请求完成'

    assert errorID == 0,u'请求失败'

    print 'test_SettlementInfoConfirm():执行结束'
    print '----------------------------------------------------------------------'
...
def test_UserLogin():
    ...
    print ''
    print '----------------------------------------------------------------------'
    print 'test_UserLogin():开始'
    sleep(1)
    ch = CTPChannel()
    data = CThostFtdcReqUserLoginField()
    errorID,errorMsg,responeDataList =  ch.UserLogin(data)
    if errorID == 0 :
        print u'共收到%d数据记录' % len(responeDataList)
        for i,responeData in enumerate(responeDataList):
            print '---------------------------------%d------------------------------------' % (i + 1)
    ...
    print 'test_UserLogin():请求完成'

    assert errorID == 0,u'请求失败'

    print 'test_UserLogin():执行结束'
    print '----------------------------------------------------------------------'
...
def test_FromFutureToBankByFuture():
    ...
    print ''
    print '----------------------------------------------------------------------'
    print 'test_FromFutureToBankByFuture():开始'
    sleep(1)
    ch = CTPChannel()
    data = CThostFtdcReqTransferField()
    errorID,errorMsg,responeDataList =  ch.FromFutureToBankByFuture(data)
    if errorID == 0 :
        print u'共收到%d数据记录' % len(responeDataList)
        for i,responeData in enumerate(responeDataList):
            print '---------------------------------%d------------------------------------' % (i + 1)
    ...
    print 'test_FromFutureToBankByFuture():请求完成'

    assert errorID == 0,u'请求失败'

    print 'test_FromFutureToBankByFuture():执行结束'
    print '----------------------------------------------------------------------'
...
def test_FromBankToFutureByFuture():
    ...
    print ''
    print '----------------------------------------------------------------------'
    print 'test_FromBankToFutureByFuture():开始'
    sleep(1)
    ch = CTPChannel()
    data = CThostFtdcReqTransferField()
    errorID,errorMsg,responeDataList =  ch.FromBankToFutureByFuture(data)
    if errorID == 0 :
        print u'共收到%d数据记录' % len(responeDataList)
        for i,responeData in enumerate(responeDataList):
            print '---------------------------------%d------------------------------------' % (i + 1)
    ...
    print 'test_FromBankToFutureByFuture():请求完成'

    assert errorID == 0,u'请求失败'

    print 'test_FromBankToFutureByFuture():执行结束'
    print '----------------------------------------------------------------------'
...
def test_ParkedOrderInsert():
    ...
    print ''
    print '----------------------------------------------------------------------'
    print 'test_ParkedOrderInsert():开始'
    sleep(1)
    ch = CTPChannel()
    data = CThostFtdcParkedOrderField()
    errorID,errorMsg,responeDataList =  ch.ParkedOrderInsert(data)
    if errorID == 0 :
        print u'共收到%d数据记录' % len(responeDataList)
        for i,responeData in enumerate(responeDataList):
            print '---------------------------------%d------------------------------------' % (i + 1)
    ...
    print 'test_ParkedOrderInsert():请求完成'

    assert errorID == 0,u'请求失败'

    print 'test_ParkedOrderInsert():执行结束'
    print '----------------------------------------------------------------------'
...
def test_OrderInsert():
    ...
    print ''
    print '----------------------------------------------------------------------'
    print 'test_OrderInsert():开始'
    sleep(1)
    ch = CTPChannel()
    data = CThostFtdcInputOrderField()
    errorID,errorMsg,responeDataList =  ch.OrderInsert(data)
    if errorID == 0 :
        print u'共收到%d数据记录' % len(responeDataList)
        for i,responeData in enumerate(responeDataList):
            print '---------------------------------%d------------------------------------' % (i + 1)
    ...
    print 'test_OrderInsert():请求完成'

    assert errorID == 0,u'请求失败'

    print 'test_OrderInsert():执行结束'
    print '----------------------------------------------------------------------'
...
def test_ParkedOrderAction():
    ...
    print ''
    print '----------------------------------------------------------------------'
    print 'test_ParkedOrderAction():开始'
    sleep(1)
    ch = CTPChannel()
    data = CThostFtdcParkedOrderActionField()
    errorID,errorMsg,responeDataList =  ch.ParkedOrderAction(data)
    if errorID == 0 :
        print u'共收到%d数据记录' % len(responeDataList)
        for i,responeData in enumerate(responeDataList):
            print '---------------------------------%d------------------------------------' % (i + 1)
    ...
    print 'test_ParkedOrderAction():请求完成'

    assert errorID == 0,u'请求失败'

    print 'test_ParkedOrderAction():执行结束'
    print '----------------------------------------------------------------------'
...
def test_Authenticate():
    ...
    print ''
    print '----------------------------------------------------------------------'
    print 'test_Authenticate():开始'
    sleep(1)
    ch = CTPChannel()
    data = CThostFtdcReqAuthenticateField()
    errorID,errorMsg,responeDataList =  ch.Authenticate(data)
    if errorID == 0 :
        print u'共收到%d数据记录' % len(responeDataList)
        for i,responeData in enumerate(responeDataList):
            print '---------------------------------%d------------------------------------' % (i + 1)
    ...
    print 'test_Authenticate():请求完成'

    assert errorID == 0,u'请求失败'

    print 'test_Authenticate():执行结束'
    print '----------------------------------------------------------------------'
...
def test_TradingAccountPasswordUpdate():
    ...
    print ''
    print '----------------------------------------------------------------------'
    print 'test_TradingAccountPasswordUpdate():开始'
    sleep(1)
    ch = CTPChannel()
    data = CThostFtdcTradingAccountPasswordUpdateField()
    errorID,errorMsg,responeDataList =  ch.TradingAccountPasswordUpdate(data)
    if errorID == 0 :
        print u'共收到%d数据记录' % len(responeDataList)
        for i,responeData in enumerate(responeDataList):
            print '---------------------------------%d------------------------------------' % (i + 1)
    ...
    print 'test_TradingAccountPasswordUpdate():请求完成'

    assert errorID == 0,u'请求失败'

    print 'test_TradingAccountPasswordUpdate():执行结束'
    print '----------------------------------------------------------------------'
...
def test_UserLogout():
    ...
    print ''
    print '----------------------------------------------------------------------'
    print 'test_UserLogout():开始'
    sleep(1)
    ch = CTPChannel()
    data = CThostFtdcUserLogoutField()
    errorID,errorMsg,responeDataList =  ch.UserLogout(data)
    if errorID == 0 :
        print u'共收到%d数据记录' % len(responeDataList)
        for i,responeData in enumerate(responeDataList):
            print '---------------------------------%d------------------------------------' % (i + 1)
    ...
    print 'test_UserLogout():请求完成'

    assert errorID == 0,u'请求失败'

    print 'test_UserLogout():执行结束'
    print '----------------------------------------------------------------------'
...
def test_OrderAction():
    ...
    print ''
    print '----------------------------------------------------------------------'
    print 'test_OrderAction():开始'
    sleep(1)
    ch = CTPChannel()
    data = CThostFtdcInputOrderActionField()
    errorID,errorMsg,responeDataList =  ch.OrderAction(data)
    if errorID == 0 :
        print u'共收到%d数据记录' % len(responeDataList)
        for i,responeData in enumerate(responeDataList):
            print '---------------------------------%d------------------------------------' % (i + 1)
    ...
    print 'test_OrderAction():请求完成'

    assert errorID == 0,u'请求失败'

    print 'test_OrderAction():执行结束'
    print '----------------------------------------------------------------------'
...
def test_RemoveParkedOrderAction():
    ...
    print ''
    print '----------------------------------------------------------------------'
    print 'test_RemoveParkedOrderAction():开始'
    sleep(1)
    ch = CTPChannel()
    data = CThostFtdcRemoveParkedOrderActionField()
    errorID,errorMsg,responeDataList =  ch.RemoveParkedOrderAction(data)
    if errorID == 0 :
        print u'共收到%d数据记录' % len(responeDataList)
        for i,responeData in enumerate(responeDataList):
            print '---------------------------------%d------------------------------------' % (i + 1)
    ...
    print 'test_RemoveParkedOrderAction():请求完成'

    assert errorID == 0,u'请求失败'

    print 'test_RemoveParkedOrderAction():执行结束'
    print '----------------------------------------------------------------------'
...
def test_RemoveParkedOrder():
    ...
    print ''
    print '----------------------------------------------------------------------'
    print 'test_RemoveParkedOrder():开始'
    sleep(1)
    ch = CTPChannel()
    data = CThostFtdcRemoveParkedOrderField()
    errorID,errorMsg,responeDataList =  ch.RemoveParkedOrder(data)
    if errorID == 0 :
        print u'共收到%d数据记录' % len(responeDataList)
        for i,responeData in enumerate(responeDataList):
            print '---------------------------------%d------------------------------------' % (i + 1)
    ...
    print 'test_RemoveParkedOrder():请求完成'

    assert errorID == 0,u'请求失败'

    print 'test_RemoveParkedOrder():执行结束'
    print '----------------------------------------------------------------------'
